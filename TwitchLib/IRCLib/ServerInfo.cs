namespace IRCLib
{
    public class ServerInfo
    {
        ...
        /// <summary>
        /// ChatSharp makes some assumptions about what the server supports in order to function
        /// properly. If it has not recieved a 005 message giving it accurate information, this
        /// value will be true.
        /// </summary>
